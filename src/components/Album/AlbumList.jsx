...
const AlbumList = () => {
  ...
  useEffect( () => {
    const token = 'BQAz_kosgnHiXDq7-KeG6j_bGyBg2I2puTQFpkG_orOdx_GaeaaCjj0o01-lcMcU-GH5jy3OqWIHw8U9ecE'
    const headers = {
                    ...
                    <div className="flex inline-flex items-center">
                      ...
                      <span className="tooltip" onClick={ () => toggleFav(id) }>
                        {isFavorite(id) ? 
                          (
                            <div>
                              <span className='tooltip-text bg-pink-800 p-3 -mt-6 -ml-4 rounded'>Remove from favorites!</span>
                          ...
                          <div>
                            <span className='tooltip-text bg-pink-800 p-3 -mt-6 -ml-4 rounded'>Add to favorites!</span>
