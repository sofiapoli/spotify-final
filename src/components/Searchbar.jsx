...
const Searchbar = () => {
  ...
  return (
    <form onSubmit={handleSubmit} className="w-full mt-4 mb-4 flex">
        ...
        />
        <button className="bg-gray-300 hover:bg-pink-900 text-gray-900 font-bold py-2 px-4 rounded">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" className="h-4" viewBox="0 0 24 24" stroke="currentColor">
